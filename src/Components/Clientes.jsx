  ...
  return (
    <div className="App">
      <header className="App-header">
        <h1 className="fadeInUp">Clientes:</h1>
        ...
        <ul>
          {data.map((cliente) => (
            <li key={cliente._id}>
              ...
              <button className="eliminar-button" onClick={() => handleEliminarCliente(cliente._id)}>Eliminar</button>
              <button className="editar-button" onClick={() => handleMostrarFormularioEdicion(cliente)}>Editar</button>
              </div>
            </li>
          ))}
        </ul>
